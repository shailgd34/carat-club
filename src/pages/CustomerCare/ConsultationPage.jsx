          ...
          <div className="p-10 lg:p-16">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-[11px] font-bold  uppercase text-brand-charcoal mb-2">First Name</label>
                ...
                <div>
                  <label className="block text-[11px] font-bold  uppercase text-brand-charcoal mb-2">Last Name</label>
                  <input type="text" className="w-full border border-brand-light-border px-5 py-4 text-[14px] outline-none focus:border-brand-gold transition-colors bg-[#FAFAFA]" />
                </div>
              </div>
              <div>
                <label className="block text-[11px] font-bold  uppercase text-brand-charcoal mb-2">Email Address</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-[11px] font-bold  uppercase text-brand-charcoal mb-2">Preferred Date</label>
                ...
                <div>
                  <label className="block text-[11px] font-bold  uppercase text-brand-charcoal mb-2">Consultation Type</label>
              ...
              <div>
                <label className="block text-[11px] font-bold  uppercase text-brand-charcoal mb-2">What would you like to discuss?</label>

  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] pt-8 pb-20 font-sans">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        {/* Breadcrumb */}
        <div className="text-[10px] uppercase  text-brand-taupe mb-8">
        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-start">
          ...
          <div className="w-full md:w-64 shrink-0 sticky top-8">
            ...
            <nav className="bg-white border border-brand-light-border flex flex-col">
              {menuItems.map(item => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 px-6 py-4 text-[12px] font-bold  uppercase transition-colors text-left border-b border-brand-light-border last:border-b-0 border-l-2 ${isActive ? 'text-brand-charcoal bg-gray-50 border-l-[#ff5474]' : 'text-brand-taupe hover:text-brand-charcoal hover:bg-gray-50 border-l-transparent hover:border-l-[#ff5474]'}`}
                  >
              ...
              <button onClick={() => setShowLogoutModal(true)} className="flex items-center gap-3 px-6 py-4 text-[12px] font-bold  uppercase text-brand-taupe hover:text-brand-charcoal hover:bg-gray-50 transition-colors text-left border-l-2 border-l-transparent hover:border-l-[#ff5474]">
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-[#FAF8F5] p-6 border border-brand-light-border text-center flex flex-col items-center">
                      ...
                      <button onClick={() => setActiveTab('orders')} className="text-[10px] uppercase  font-bold text-brand-charcoal underline hover:text-[#ff5474]">View Orders</button>
                    </div>
                    <div className="bg-[#FAF8F5] p-6 border border-brand-light-border text-center flex flex-col items-center">
                      ...
                      <button onClick={() => setActiveTab('saved')} className="text-[10px] uppercase  font-bold text-brand-charcoal underline hover:text-[#ff5474]">View Wishlist</button>
                    </div>
                    <div className="bg-[#FAF8F5] p-6 border border-brand-light-border text-center flex flex-col items-center">
                      ...
                      <button onClick={() => setActiveTab('address')} className="text-[10px] uppercase  font-bold text-brand-charcoal underline hover:text-[#ff5474]">Edit Addresses</button>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section id="orders" className="bg-white border border-brand-light-border p-6 md:p-10 animate-fade-in-up">
                ...
                <div className="border border-brand-light-border rounded overflow-hidden">
                  <table className="w-full text-sm text-left">
                    <thead className="text-[10px] uppercase  text-brand-charcoal bg-gray-50 border-b border-brand-light-border">
                      <tr>
                    ...
                    <tbody>
                      <tr className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 text-right">
                          <button className="text-[10px] uppercase  font-bold text-brand-charcoal border border-brand-charcoal px-3 py-1 hover:bg-brand-charcoal hover:text-white transition-colors">
                            Track
                          </button>
                        </td>
                      </tr>
            ...
            {activeTab === 'address' && (
              <section id="address" className="bg-white border border-brand-light-border p-6 md:p-10 animate-fade-in-up">
                <div className="flex justify-between items-end mb-6">
                  ...
                  <button className="bg-brand-charcoal text-white text-[10px] font-bold uppercase  px-4 py-2 hover:bg-black transition-colors">Add New Address</button>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-[#FAF8F5] border border-brand-light-border p-6 relative">
                    <span className="absolute top-0 right-0 bg-[#ff5474] text-white text-[9px] font-bold uppercase  px-2 py-1">Default Shipping</span>
                    ...
                    <div className="flex gap-4 border-t border-brand-light-border pt-4">
                      <button className="text-[11px] uppercase  font-bold text-brand-charcoal hover:text-[#ff5474]">Edit</button>
                      <button className="text-[11px] uppercase  font-bold text-gray-400 hover:text-red-500">Delete</button>
                    </div>
                  </div>
                </div>
              </section>
            ...
            {activeTab === 'payment' && (
              <section id="payment" className="bg-white border border-brand-light-border p-6 md:p-10 animate-fade-in-up">
                <div className="flex justify-between items-end mb-6">
                  ...
                  <button className="bg-brand-charcoal text-white text-[10px] font-bold uppercase  px-4 py-2 hover:bg-black transition-colors">Add New Card</button>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-[#FAF8F5] border border-brand-light-border p-6 relative">
                    <span className="absolute top-0 right-0 bg-[#ff5474] text-white text-[9px] font-bold uppercase  px-2 py-1">Default</span>
                    ...
                    <div className="flex gap-4 border-t border-brand-light-border pt-4">
                      <button className="text-[11px] uppercase  font-bold text-brand-charcoal hover:text-[#ff5474]">Edit</button>
                      <button className="text-[11px] uppercase  font-bold text-gray-400 hover:text-red-500">Remove</button>
                    </div>
                  </div>
                </div>
              </section>
                  ...
                  <div className="flex items-center gap-6 pb-6 border-b border-brand-light-border">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex gap-3 mt-1">
                        <label className="cursor-pointer bg-brand-charcoal text-white text-[10px] font-bold uppercase  px-4 py-2 hover:bg-black transition-colors flex items-center gap-2">
                          <Camera className="w-3.5 h-3.5" />
                          Change Image
                          <input type="file" className="hidden" accept="image/*" />
                        </label>
                        <button type="button" className="text-[10px] uppercase  font-bold text-gray-400 hover:text-red-500 transition-colors">
                          Remove
                        </button>
                      </div>
                    </div>
                  ...
                  <form className="space-y-8 mt-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="relative group pt-4">
                        ...
                        <label htmlFor="firstName" className="absolute left-0 top-6 text-[13px] text-[#777]  uppercase transition-all peer-focus:top-0 peer-focus:text-[11px] peer-focus:font-semibold peer-focus:text-[#ff5474] peer-valid:top-0 peer-valid:text-[11px] peer-valid:font-semibold peer-valid:text-[#555]">First Name</label>
                      </div>
                      ...
                      <div className="relative group pt-4">
                        ...
                        <label htmlFor="lastName" className="absolute left-0 top-6 text-[13px] text-[#777]  uppercase transition-all peer-focus:top-0 peer-focus:text-[11px] peer-focus:font-semibold peer-focus:text-[#ff5474] peer-valid:top-0 peer-valid:text-[11px] peer-valid:font-semibold peer-valid:text-[#555]">Last Name</label>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="relative group pt-4">
                        ...
                        <label htmlFor="email" className="absolute left-0 top-6 text-[13px] text-[#777]  uppercase transition-all peer-focus:top-0 peer-focus:text-[11px] peer-focus:font-semibold peer-focus:text-[#ff5474] peer-valid:top-0 peer-valid:text-[11px] peer-valid:font-semibold peer-valid:text-[#555]">Email Address</label>
                      </div>
                      ...
                      <div className="relative group pt-4">
                        ...
                        <label htmlFor="phone" className="absolute left-0 top-6 text-[13px] text-[#777]  uppercase transition-all peer-focus:top-0 peer-focus:text-[11px] peer-focus:font-semibold peer-focus:text-[#ff5474] peer-valid:top-0 peer-valid:text-[11px] peer-valid:font-semibold peer-valid:text-[#555]">Phone Number</label>
                      </div>
                    </div>
                    ...
                    <div className="relative group pt-4 mb-8">
                      ...
                      <label htmlFor="dob" className="absolute left-0 top-0 text-[11px] font-semibold text-[#555]  uppercase transition-all peer-focus:text-[#ff5474]">Date of Birth</label>
                    </div>
                    ...
                    <div className="pt-8 border-t border-brand-light-border">
                      ...
                      <div className="space-y-8">
                        <div className="relative group pt-4">
                          ...
                          <label htmlFor="currentPassword" className="absolute left-0 top-6 text-[13px] text-[#777]  uppercase transition-all peer-focus:top-0 peer-focus:text-[11px] peer-focus:font-semibold peer-focus:text-[#ff5474] peer-valid:top-0 peer-valid:text-[11px] peer-valid:font-semibold peer-valid:text-[#555]">Current Password</label>
                        </div>
                        <div className="relative group pt-4">
                          ...
                          <label htmlFor="newPassword" className="absolute left-0 top-6 text-[13px] text-[#777]  uppercase transition-all peer-focus:top-0 peer-focus:text-[11px] peer-focus:font-semibold peer-focus:text-[#ff5474] peer-valid:top-0 peer-valid:text-[11px] peer-valid:font-semibold peer-valid:text-[#555]">New Password</label>
                        </div>
                      </div>
                    </div>

                    <div className="pt-8">
                      <button type="submit" className="w-full bg-brand-charcoal text-white text-[12px] font-bold  uppercase py-4 hover:bg-brand-gold transition-colors">
                        Save Changes
                      </button>
                    </div>
                  </form>
          ...
          <div className="bg-white shadow-2xl w-full max-w-md relative z-10 animate-fade-in-up">
            ...
            <div className="p-8 text-center">
              ...
              <div className="flex gap-4">
                <button onClick={() => setShowLogoutModal(false)} className="flex-1 py-4 border border-brand-light-border text-[11px] font-bold  uppercase text-brand-charcoal hover:bg-gray-50 transition-colors">
                  CANCEL
                </button>
                <button onClick={() => navigate('/auth')} className="flex-1 py-4 bg-brand-charcoal text-[11px] font-bold  uppercase text-white hover:bg-brand-gold transition-colors">
                  SIGN OUT
                </button>
              </div>
            </div>

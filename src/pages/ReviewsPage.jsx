        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="w-full lg:w-[400px] shrink-0 lg:sticky lg:top-24">
            ...
            <div className="bg-white border border-[#E5E5E5] p-8 shadow-sm">
              <div className="text-center py-4">
                ...
                <button onClick={() => setShowForm(true)} className="relative group overflow-hidden w-full bg-[#101010] text-white text-[12px] font-bold tracking-widest uppercase py-4 transition-all duration-500 shadow-lg hover:shadow-[#ff5474]/30 rounded-[2px]">
          ...
          <div className="flex-1 w-full">
              ...
              {reviews.map(review => (
                <div key={review.id} className="bg-white border border-[#E5E5E5] p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col sm:flex-row gap-6">
                  <div className="flex-1">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-bold text-[14px] tracking-wide text-[#101010]">{review.name}</span>
                    ...
                    {review.productId && (
                      <div className="mt-4">
                        <Link to={`/product/${review.productId}`} className="text-[11px] font-bold tracking-widest uppercase text-[#101010] hover:text-[#ff5474] underline underline-offset-4 transition-colors">
                          View Product
                        </Link>
                      </div>
                    )}
            ...
            <div className="mt-12 text-center">
              <button className="border border-[#101010] text-[#101010] text-[11px] font-bold tracking-widest uppercase px-10 py-4 hover:bg-[#101010] hover:text-white transition-colors rounded-[2px]">
                Load More Reviews
              </button>
            </div>
          </div>
          ...
          <div className="bg-white shadow-2xl w-full max-w-2xl relative z-10 animate-fade-in-up flex flex-col max-h-[90vh] rounded-[2px]">
            ...
            <div className="p-8 overflow-y-auto">
              ...
              <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); setShowForm(false); }}>
                ...
                <div className="pt-2">
                  <button type="submit" className="w-full py-4 bg-[#101010] text-white text-[12px] font-bold tracking-widest uppercase hover:bg-[#ff5474] transition-colors rounded-[2px]">
                    Submit Review
                  </button>
                </div>
              </form>

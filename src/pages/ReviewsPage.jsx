...
export default function ReviewsPage() {
  ...
  return (
    <div className="font-sans text-[#101010] bg-[#FAFAFA] min-h-screen pt-12 pb-24">

      <div className="max-w-[1400px] mx-auto px-4 lg:px-8">

        {/* Page Title */}
        <div className="text-center mb-16">
          <h1 className="font-serif text-[42px] lg:text-[56px] text-[#101010] mb-4 italic">Client Stories</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="w-full lg:w-[400px] shrink-0 lg:sticky lg:top-24">
            ...
            <div className="bg-white border border-[#E5E5E5] p-8 mb-8 shadow-sm">
              <h2 className="font-serif text-2xl text-[#101010] mb-6">Overall Rating</h2>
              ...
              <div className="flex items-end gap-3 mb-6">
                ...
                <div className="pb-1">
                  ...
                  <span className="text-[11px] text-[#777] uppercase  font-bold">Based on 400+ reviews</span>
                </div>
              </div>
            ...
            <div className="bg-white border border-[#E5E5E5] p-8 shadow-sm">
              <div className="text-center py-4">
                <h3 className="font-serif text-2xl text-[#101010] mb-4">Share Your Experience</h3>
                <button onClick={() => setShowForm(true)} className="relative group overflow-hidden w-full bg-[#101010] text-white text-[12px] font-bold  uppercase py-4 transition-all duration-500 shadow-lg hover:shadow-[#ff5474]/30 rounded-[2px]">
          ...
          <div className="flex-1 w-full">
              ...
              {reviews.map(review => (
                <div key={review.id} className="bg-white border border-[#E5E5E5] p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col sm:flex-row gap-6">
                  <div className="flex-1">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-bold text-[14px]  text-[#101010]">{review.name}</span>
                      ...
                      <div className="flex flex-col items-end gap-1">
                        <span className="text-[10px] text-[#777] uppercase ">{review.date}</span>
                    ...
                    <h4 className="font-serif text-[18px] text-[#101010] mb-3 italic">{review.title}</h4>
                    <p className="text-[14px] text-[#555] leading-relaxed font-light">{review.text}</p>
                    {review.productId && (
                      <div className="mt-4">
                        <Link to={`/product/${review.productId}`} className="text-[11px] font-bold  uppercase text-[#101010] hover:text-[#ff5474] underline underline-offset-4 transition-colors">
                          View Product
                        </Link>
                      </div>
                    )}
            ...
            <div className="mt-12 text-center">
              <button className="border border-[#101010] text-[#101010] text-[11px] font-bold  uppercase px-10 py-4 hover:bg-[#101010] hover:text-white transition-colors rounded-[2px]">
                Load More Reviews
              </button>
            </div>
          </div>
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white shadow-2xl w-full max-w-2xl relative z-10 animate-fade-in-up flex flex-col max-h-[90vh] rounded-[2px]">
            <button onClick={() => setShowForm(false)} className="absolute top-6 right-6 text-gray-400 hover:text-[#101010] transition-colors z-20">
              <X size={24} />
            </button>

            <div className="p-8 overflow-y-auto">
              <h2 className="font-serif text-2xl text-[#101010] mb-1">Share Your Experience</h2>
              ...
              <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); setShowForm(false); }}>
                ...
                {/* Rating */}
                <div>
                  <label className="block text-[11px] font-bold  uppercase text-[#777] mb-2">Overall Rating</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="relative group pt-4">
                    <input type="text" id="reviewName" required className="peer w-full bg-transparent border-b border-[#C4C4C4] py-1 text-[14px] text-[#101010] outline-none focus:border-[#ff5474] transition-colors placeholder-transparent" placeholder="Name" />
                    <label htmlFor="reviewName" className="absolute left-0 top-5 text-[10px] text-[#777]  uppercase transition-all peer-focus:top-0 peer-focus:text-[9px] peer-focus:font-bold peer-focus:text-[#ff5474] peer-valid:top-0 peer-valid:text-[9px] peer-valid:font-bold peer-valid:text-[#555]">Name</label>
                  </div>
                  <div className="relative group pt-4">
                    <input type="email" id="reviewEmail" required className="peer w-full bg-transparent border-b border-[#C4C4C4] py-1 text-[14px] text-[#101010] outline-none focus:border-[#ff5474] transition-colors placeholder-transparent" placeholder="Email" />
                    <label htmlFor="reviewEmail" className="absolute left-0 top-5 text-[10px] text-[#777]  uppercase transition-all peer-focus:top-0 peer-focus:text-[9px] peer-focus:font-bold peer-focus:text-[#ff5474] peer-valid:top-0 peer-valid:text-[9px] peer-valid:font-bold peer-valid:text-[#555]">Email</label>
                  </div>
                </div>

                <div className="relative group pt-4">
                  <input type="text" id="reviewTitle" required className="peer w-full bg-transparent border-b border-[#C4C4C4] py-1 text-[14px] text-[#101010] outline-none focus:border-[#ff5474] transition-colors placeholder-transparent" placeholder="Review Title" />
                  <label htmlFor="reviewTitle" className="absolute left-0 top-5 text-[10px] text-[#777]  uppercase transition-all peer-focus:top-0 peer-focus:text-[9px] peer-focus:font-bold peer-focus:text-[#ff5474] peer-valid:top-0 peer-valid:text-[9px] peer-valid:font-bold peer-valid:text-[#555]">Review Title</label>
                </div>

                <div className="relative group pt-4">
                  <textarea id="reviewText" required rows="2" className="peer w-full bg-transparent border-b border-[#C4C4C4] py-1 text-[14px] text-[#101010] outline-none focus:border-[#ff5474] transition-colors placeholder-transparent resize-none" placeholder="Review"></textarea>
                  <label htmlFor="reviewText" className="absolute left-0 top-5 text-[10px] text-[#777]  uppercase transition-all peer-focus:top-0 peer-focus:text-[9px] peer-focus:font-bold peer-focus:text-[#ff5474] peer-valid:top-0 peer-valid:text-[9px] peer-valid:font-bold peer-valid:text-[#555]">Your Review</label>
                </div>

                <div>
                  <label className="block text-[11px] font-bold  uppercase text-[#777] mb-2">Add Photos</label>
                  <div className="border border-dashed border-[#C4C4C4] bg-[#FAFAFA] rounded-sm p-4 text-center hover:bg-gray-50 transition-colors cursor-pointer group">
                    ...
                    <p className="text-[11px] text-[#101010] font-medium">Click to upload images</p>
                    <p className="text-[9px] text-[#777] mt-1">JPG, PNG up to 5MB</p>
                  </div>
                </div>

                <div className="pt-2">
                  <button type="submit" className="w-full py-4 bg-[#101010] text-white text-[12px] font-bold  uppercase hover:bg-[#ff5474] transition-colors rounded-[2px]">
                    Submit Review
                  </button>
                </div>
              </form>

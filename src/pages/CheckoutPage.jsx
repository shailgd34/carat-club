    ...
    <div className="min-h-screen bg-brand-ivory font-sans text-brand-charcoal flex flex-col lg:flex-row selection:bg-brand-gold selection:text-white">
      ...
      <div className="w-full lg:w-[55%] xl:w-[60%] lg:border-r border-brand-light-border pt-12 lg:pt-16 pb-24 px-6 lg:px-16 xl:px-32 flex justify-end bg-white">
        <div className="w-full max-w-[540px]">
          ...
          <Link to="/" className="block mb-10 lg:mb-14 flex flex-col items-start">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="font-serif text-[24px]  text-brand-charcoal uppercase leading-none">Carat Club</span>
          ...
          {/* Breadcrumbs */}
          <div className="flex items-center gap-3 text-[10px] font-bold  uppercase mb-12">
          ...
          <form className="space-y-12" onSubmit={(e) => { e.preventDefault(); setIsSuccess(true); }}>
            ...
            <section>
              ...
              <div className="relative group">
                ...
                />
                <label htmlFor="contact-email" className="absolute left-0 top-1 text-[10px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1 peer-focus:text-[10px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">
            ...
            <section>
              ...
              <div className="space-y-5">
                <div className="relative">
                  ...
                  <label className="absolute left-0 top-1 text-[10px] font-bold uppercase  text-brand-taupe pointer-events-none">
                    Country / Region
                  </label>
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div className="relative">
                    ...
                    <label htmlFor="first-name" className="absolute left-0 top-1 text-[10px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1 peer-focus:text-[10px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">First name</label>
                  </div>
                  <div className="relative">
                    ...
                    <label htmlFor="last-name" className="absolute left-0 top-1 text-[10px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1 peer-focus:text-[10px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">Last name</label>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <label htmlFor="address" className="absolute left-0 top-1 text-[10px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1 peer-focus:text-[10px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">Address</label>
                </div>
                ...
                <div className="relative">
                  ...
                  <label htmlFor="apartment" className="absolute left-0 top-1 text-[10px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1 peer-focus:text-[10px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">Apartment, suite, etc. (optional)</label>
                </div>
                ...
                <div className="grid grid-cols-3 gap-5">
                  <div className="relative">
                    ...
                    <label htmlFor="city" className="absolute left-0 top-1 text-[10px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1 peer-focus:text-[10px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">City</label>
                  </div>
                  <div className="relative">
                    ...
                    <label htmlFor="state" className="absolute left-0 top-1 text-[10px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1 peer-focus:text-[10px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">State</label>
                  </div>
                  <div className="relative">
                    ...
                    <label htmlFor="postcode" className="absolute left-0 top-1 text-[10px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1 peer-focus:text-[10px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">Postcode</label>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <span className="font-bold text-[11px] uppercase  text-brand-charcoal">Pay in Full</span>
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <span className="font-bold text-[11px] uppercase  text-brand-charcoal">30% Deposit</span>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-[10px] uppercase  text-brand-taupe flex items-center gap-1">
              ...
              <div className="border border-brand-light-border bg-brand-ivory/50 rounded-sm overflow-hidden transition-all duration-300 focus-within:border-brand-charcoal focus-within:bg-white focus-within:shadow-[0_4px_20px_-10px_rgba(0,0,0,0.1)]">
                <div className="flex items-center gap-4 p-5 border-b border-brand-light-border bg-white">
                  ...
                  <span className="font-bold text-[12px] uppercase  text-brand-charcoal">Credit Card</span>
                ...
                <div className="p-5 space-y-4">
                  <div className="relative">
                    ...
                    <label htmlFor="card-number" className="absolute left-3 top-1.5 text-[9px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1.5 peer-focus:text-[9px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">Card number</label>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="relative">
                      ...
                      <label htmlFor="expiry" className="absolute left-3 top-1.5 text-[9px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1.5 peer-focus:text-[9px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">Expiration (MM/YY)</label>
                    </div>
                    <div className="relative">
                      ...
                      <label htmlFor="cvc" className="absolute left-3 top-1.5 text-[9px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1.5 peer-focus:text-[9px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">Security code</label>
                    </div>
                  </div>
                  <div className="relative">
                    ...
                    <label htmlFor="name-on-card" className="absolute left-3 top-1.5 text-[9px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-[13px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1.5 peer-focus:text-[9px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">Name on card</label>
                  </div>
                </div>
              </div>
            </section>
      ...
      <div className="w-full lg:w-[45%] xl:w-[40%] bg-brand-cream pt-12 lg:pt-16 pb-24 px-6 lg:px-12 xl:px-20 border-t lg:border-t-0 border-brand-light-border">
        <div className="w-full max-w-[420px] sticky top-16">
          ...
          <div className="flex gap-5 items-center pb-8 mb-8 border-b border-brand-light-border">
            ...
            <div className="flex flex-col">
              <h4 className="font-bold text-[12px] text-brand-charcoal uppercase  mb-1">Classic Solitaire</h4>
          ...
          <div className="flex gap-3 mb-8 border-b border-brand-light-border pb-8">
            <div className="relative flex-1">
              ...
              <label htmlFor="discount" className="absolute left-4 top-1.5 text-[9px] font-bold uppercase  text-brand-taupe transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-[12px] peer-placeholder-shown:normal-case peer-placeholder-shown:font-normal peer-focus:top-1.5 peer-focus:text-[9px] peer-focus:font-bold peer-focus:uppercase peer-focus:text-brand-charcoal cursor-text">Gift card or discount code</label>
            </div>
            <button className="bg-brand-light-border/50 text-brand-taupe px-5 text-[10px] font-bold  uppercase hover:bg-brand-charcoal hover:text-white transition-colors rounded-sm border border-brand-light-border shadow-sm">Apply</button>
          </div>
          ...
          <div className="border-t border-brand-light-border pt-6">
            <div className="flex justify-between items-end mb-4">
              <span className="text-[14px] text-brand-charcoal font-bold uppercase ">Total</span>
          ...
          <div className="bg-white shadow-2xl w-full max-w-lg relative z-10 animate-fade-in-up">
            ...
            <div className="p-10 text-center">
              ...
              <div className="border-t border-brand-light-border pt-8 mt-2">
                ...
                <Link to="/reviews" className="inline-block border border-brand-charcoal text-brand-charcoal text-[11px] font-bold  uppercase px-6 py-3 hover:bg-brand-charcoal hover:text-white transition-colors">
                  Write a Full Review
                </Link>
              </div>
              
              <div className="mt-8">
                <Link to="/" className="text-[11px] font-bold  uppercase text-brand-taupe hover:text-brand-charcoal underline">
                  Return to Home
                </Link>
              </div>
            </div>

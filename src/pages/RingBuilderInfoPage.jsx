    ...
    <div className="bg-[#FAF8F5] min-h-screen font-sans text-[#101010]">
      ...
      <section className="pt-4 pb-8 lg:pt-8 lg:pb-8 px-6 overflow-hidden max-h-[500px] lg:max-h-[400px] flex items-center">
        <div className="max-w-[1600px] w-full mx-auto flex flex-col lg:flex-row items-center gap-6 lg:gap-12 relative">
          ...
          <div className="lg:w-[45%] flex flex-col justify-center text-center lg:text-left lg:pl-12">
            ...
            <h1 className="font-serif text-[40px] md:text-[50px] lg:text-[56px] leading-[1.05] tracking-tight mb-4 text-[#101010]">
            ...
            <div className="flex justify-center lg:justify-start">
              <Link to="/custom-jewellery" className="bg-[#ff5474] text-white text-[11px] font-bold tracking-[0.2em] uppercase py-4 px-10 hover:shadow-[0_15px_30px_rgba(255,84,116,0.3)] hover:-translate-y-1 transition-all duration-300 rounded-full flex items-center gap-2">
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="text-center mb-20">
            <h2 className="font-serif text-[42px] lg:text-[56px] text-[#101010] mb-4">How It Works</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
            ...
            <div className="bg-[#FAF8F5] rounded-3xl p-10 flex flex-col items-center text-center group hover:bg-white hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)] transition-all duration-500 border border-transparent hover:border-[#E5E5E5] relative overflow-hidden">
              ...
              <h3 className="font-serif text-[28px] text-[#101010] mb-4 relative z-10">Select Your Ring Setting</h3>
              ...
              <ul className="text-left space-y-2 w-full mt-auto relative z-10 border-t border-[#E5E5E5] pt-6">
                <li className="flex items-start gap-3 text-[13px] text-[#101010] font-medium"><svg className="w-4 h-4 text-[#ff5474] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" strokeWidth="2"></polyline></svg> Choose 18K Gold or Platinum</li>
                <li className="flex items-start gap-3 text-[13px] text-[#101010] font-medium"><svg className="w-4 h-4 text-[#ff5474] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" strokeWidth="2"></polyline></svg> Customize band details</li>
              </ul>
            </div>
            ...
            <div className="bg-[#FAF8F5] rounded-3xl p-10 flex flex-col items-center text-center group hover:bg-white hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)] transition-all duration-500 border border-transparent hover:border-[#E5E5E5] relative overflow-hidden lg:-translate-y-8">
              ...
              <h3 className="font-serif text-[28px] text-[#101010] mb-4 relative z-10">Select Your Diamond</h3>
              <p className="text-[15px] text-[#666] leading-relaxed font-light mb-6 relative z-10">
                Access our live global inventory of premium, ethically sourced lab-grown diamonds. Filter by cut and carat.
              </p>
              <ul className="text-left space-y-2 w-full mt-auto relative z-10 border-t border-[#E5E5E5] pt-6">
                <li className="flex items-start gap-3 text-[13px] text-[#101010] font-medium"><svg className="w-4 h-4 text-[#ff5474] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" strokeWidth="2"></polyline></svg> 360° HD videos of every stone</li>
                <li className="flex items-start gap-3 text-[13px] text-[#101010] font-medium"><svg className="w-4 h-4 text-[#ff5474] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" strokeWidth="2"></polyline></svg> Strict wholesale margins</li>
              </ul>
            </div>
            ...
            <div className="bg-[#FAF8F5] rounded-3xl p-10 flex flex-col items-center text-center group hover:bg-white hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)] transition-all duration-500 border border-transparent hover:border-[#E5E5E5] relative overflow-hidden">
              ...
              <h3 className="font-serif text-[28px] text-[#101010] mb-4 relative z-10">Complete Your Ring</h3>
              <p className="text-[15px] text-[#666] leading-relaxed font-light mb-6 relative z-10">
                Review your final 3D render in high definition. Add a personalized inner engraving and place your order.
              </p>
              <ul className="text-left space-y-2 w-full mt-auto relative z-10 border-t border-[#E5E5E5] pt-6">
                <li className="flex items-start gap-3 text-[13px] text-[#101010] font-medium"><svg className="w-4 h-4 text-[#ff5474] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" strokeWidth="2"></polyline></svg> 30% upfront deposit option</li>
                <li className="flex items-start gap-3 text-[13px] text-[#101010] font-medium"><svg className="w-4 h-4 text-[#ff5474] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" strokeWidth="2"></polyline></svg> Premium quality, accessible prices</li>
              </ul>
            </div>
      ...
      <section className="bg-[#FAF8F5] py-24 text-center border-t border-[#E5E5E5]">
        <div className="max-w-2xl mx-auto px-6">
          <h2 className="font-serif text-[36px] lg:text-[48px] text-[#101010] mb-6 leading-tight">Your story, beautifully set.</h2>

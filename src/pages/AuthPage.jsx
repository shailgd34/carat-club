          ...
          {(view === 'login' || view === 'signup') && (
            <div className="flex justify-center gap-8 mb-6">
              <button
                ...
                className={`text-[13px] font-bold tracking-widest uppercase transition-all duration-500 relative pb-3 ${view === 'login' ? 'text-[#101010]' : 'text-[#777] hover:text-[#444]'}`}
              >
                Log In
              ...
              <button
                ...
                className={`text-[13px] font-bold tracking-widest uppercase transition-all duration-500 relative pb-3 ${view === 'signup' ? 'text-[#101010]' : 'text-[#777] hover:text-[#444]'}`}
              >
                Sign Up
          ...
          <form className="space-y-5" onSubmit={(e) => {
            ...
            {(view === 'forgot' || view === 'otp' || view === 'reset') && (
              <div className="text-center pt-2">
                <button type="button" onClick={() => setView('login')} className="text-[12px] text-[#777] hover:text-[#101010] font-semibold tracking-widest uppercase transition-colors">
                  Back to Login
                </button>
              </div>
            )}
          ...
          {(view === 'login' || view === 'signup') && (
            <div className="mt-8 pt-6 border-t border-black/10">
              ...
              <div className="flex gap-4">
                <button className="flex-1 flex justify-center items-center gap-2 py-3 border border-[#DCDCDC] bg-white text-[12px] font-bold tracking-widest uppercase text-[#101010] hover:border-[#ff5474] hover:bg-gray-50 transition-colors rounded-[2px]">
          ...
          <div className="bg-white shadow-2xl w-full max-w-md relative z-10 animate-fade-in-up">
            ...
            <div className="p-8 text-center">
              ...
              <div className="flex justify-center">
                <button onClick={() => { setIsSuccess(false); setView('login'); }} className="w-full py-4 bg-[#101010] text-[11px] font-bold tracking-widest uppercase text-white hover:bg-[#ff5474] transition-colors rounded-[2px]">
                  Back to Login
                </button>
              </div>
            </div>

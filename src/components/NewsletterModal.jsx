  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        <button
          onClick={handleClose}
          className="absolute top-4 right-4 z-10 w-8 h-8 flex items-center justify-center bg-white/50 hover:bg-[#ff5474] text-[#101010] hover:text-white rounded-full transition-colors backdrop-blur-sm"
        >
        ...
        <div className="w-full md:w-1/2 p-10 md:p-14 flex flex-col justify-center bg-[#FAF8F5] relative">
          ...
          <h3 className="font-serif text-3xl md:text-4xl text-[#101010] mb-4 leading-tight">Join The Carat Club</h3>
          ...
          <form className="flex flex-col gap-4" onSubmit={(e) => { e.preventDefault(); handleClose(); }}>
            <div className="relative">
              <input
                ...
                className="w-full bg-white border border-[#E5E5E5] text-[#101010] text-sm px-5 py-4 outline-none focus:border-[#ff5474] transition-colors"
                required
              />
            </div>
            <button

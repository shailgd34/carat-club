    ...
    <section className="relative bg-[#FAF8F5] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-4 lg:px-8 py-10 lg:py-12 grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <div className="text-center lg:text-left flex flex-col items-center lg:items-start lg:pl-12 xl:pl-20">
          ...
          <h2 className="text-5xl lg:text-6xl font-serif text-[#101010] mb-6 leading-tight capitalize">
            Can’t Find Exactly <br className="hidden lg:block" /> What You Want?
          </h2>
          <p className="text-base text-[#666] mb-10 max-w-lg font-medium leading-relaxed">

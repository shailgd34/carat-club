    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-slideUp">
        ...
        <div className="px-8 py-6 border-b border-[#E5E5E5] flex items-center justify-between bg-[#FAF8F5]">
          <h2 className="font-serif text-[28px] text-[#101010]">Ring Size Guide</h2>
          <button
            onClick={onClose}
            className="w-10 h-10 rounded-full flex items-center justify-center bg-white border border-[#E5E5E5] text-[#101010] hover:bg-[#ff5474] hover:text-white hover:border-[#ff5474] transition-colors"
          >
        ...
        <div className="p-8 overflow-y-auto custom-scrollbar">
          ...
          <div className="mb-10 text-center">
            <h3 className="font-sans text-[16px] font-semibold text-[#101010] uppercase tracking-widest mb-3">How to Measure</h3>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr>
                  <th className="py-4 px-6 bg-[#FAF8F5] font-sans text-[11px] font-bold uppercase tracking-widest text-[#101010] border-b border-[#E5E5E5] rounded-tl-lg">UK & Australia</th>
                  <th className="py-4 px-6 bg-[#FAF8F5] font-sans text-[11px] font-bold uppercase tracking-widest text-[#101010] border-b border-[#E5E5E5]">US & Canada</th>
                  <th className="py-4 px-6 bg-[#FAF8F5] font-sans text-[11px] font-bold uppercase tracking-widest text-[#101010] border-b border-[#E5E5E5]">Europe</th>
                  <th className="py-4 px-6 bg-[#FAF8F5] font-sans text-[11px] font-bold uppercase tracking-widest text-[#101010] border-b border-[#E5E5E5] rounded-tr-lg">Inside Circumference (mm)</th>
                </tr>
              </thead>
              <tbody className="text-[14px] text-[#555]">
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">H</td>
                  <td className="py-4 px-6">4</td>
                  <td className="py-4 px-6">46.5</td>
                  <td className="py-4 px-6">46.8</td>
                </tr>
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">I</td>
                  <td className="py-4 px-6">4.5</td>
                  <td className="py-4 px-6">47.8</td>
                  <td className="py-4 px-6">48.0</td>
                </tr>
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">J</td>
                  <td className="py-4 px-6">5</td>
                  <td className="py-4 px-6">49.0</td>
                  <td className="py-4 px-6">49.3</td>
                </tr>
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">K</td>
                  <td className="py-4 px-6">5.5</td>
                  <td className="py-4 px-6">50.3</td>
                  <td className="py-4 px-6">50.6</td>
                </tr>
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">L</td>
                  <td className="py-4 px-6">6</td>
                  <td className="py-4 px-6">51.5</td>
                  <td className="py-4 px-6">51.9</td>
                </tr>
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">M</td>
                  <td className="py-4 px-6">6.5</td>
                  <td className="py-4 px-6">52.8</td>
                  <td className="py-4 px-6">53.1</td>
                </tr>
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">N</td>
                  <td className="py-4 px-6">7</td>
                  <td className="py-4 px-6">54.0</td>
                  <td className="py-4 px-6">54.4</td>
                </tr>
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">O</td>
                  <td className="py-4 px-6">7.5</td>
                  <td className="py-4 px-6">55.3</td>
                  <td className="py-4 px-6">55.7</td>
                </tr>
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">P</td>
                  <td className="py-4 px-6">8</td>
                  <td className="py-4 px-6">56.6</td>
                  <td className="py-4 px-6">57.0</td>
                </tr>
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">Q</td>
                  <td className="py-4 px-6">8.5</td>
                  <td className="py-4 px-6">57.8</td>
                  <td className="py-4 px-6">58.3</td>
                </tr>
                <tr className="hover:bg-[#ff5474]/5 transition-colors border-b border-[#E5E5E5]">
                  <td className="py-4 px-6 font-medium text-[#101010]">R</td>
          ...
          <div className="mt-8 bg-[#ff5474]/5 border border-[#ff5474]/10 rounded-xl p-6 text-center">
            ...
            <div className="flex items-center justify-center gap-4">
              <button className="text-[11px] font-bold tracking-widest text-white bg-[#101010] px-6 py-3 uppercase rounded hover:bg-[#ff5474] transition-colors">Request Free Sizer</button>
            </div>
          </div>

          ...
          <div className="max-w-[1600px] mx-auto px-8 py-8 flex gap-8">
            ...
            <div className="w-[60%] flex gap-4">
              {(data.tabs[activeMegaTab]?.products || []).slice(0, 3).map((product, i) => (
                <Link to={`/product/${i + 1}`} key={i} className="flex-1 bg-[#FAF8F5] border border-transparent p-6 flex flex-col group/prod cursor-pointer hover:border-[#E5E5E5] hover:bg-white hover:shadow-sm transition-all duration-300 relative text-center block">
                  ...
                  <p className="text-[9px] tracking-wider capitalize text-gray-500 mb-4">{product.subtitle}</p>
            ...
            <div className="w-[20%] flex flex-col">
              <Link to="/ring-builder" className="flex-1 bg-[#101010] border border-transparent p-6 flex flex-col items-center justify-center group/builder cursor-pointer hover:shadow-xl transition-all duration-300 text-center relative overflow-hidden">
                ...
                <h3 className="text-white font-serif text-[18px] lg:text-[22px] tracking-wide capitalize mb-10 relative z-10">BUILD YOUR RING</h3>
            ...
            {data.categories.map((cat, i) => (
              <Link to={cat.link || "#"} key={i} className="flex-1 relative group/card cursor-pointer h-[260px] overflow-hidden rounded-sm block">
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  <h3 className="text-white text-[16px] font-serif font-bold mb-2 capitalize tracking-wide">{cat.name}</h3>
                  <div className="overflow-hidden">
                    <span className="text-[10px] tracking-wide capitalize text-[#ff5474] font-bold flex items-center gap-1 transform translate-y-full opacity-0 group-hover/card:translate-y-0 group-hover/card:opacity-100 transition-all duration-300">
          ...
          <div className="max-w-[1600px] mx-auto px-8 py-10 flex gap-8">
            <Link to={data.featured.link} className="w-1/3 relative group/feature h-[320px] overflow-hidden rounded-sm block">
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end">
                <h3 className="text-white text-[24px] font-serif font-bold mb-2 capitalize tracking-wide">{data.featured.title}</h3>
                <p className="text-gray-300 text-[13px] mb-4">{data.featured.subtitle}</p>
                <span className="text-[10px] tracking-wide capitalize text-[#ff5474] font-bold flex items-center gap-1 group-hover/feature:text-white transition-colors">
              ...
              {data.categories.map((cat, i) => (
                <Link to="#" key={i} className="relative group/card h-[152px] overflow-hidden rounded-sm block bg-[#FAF8F5]">
                  ...
                  <div className="absolute inset-0 p-4 flex items-center justify-center text-center">
                    <h3 className="text-white text-[13px] tracking-wide font-bold capitalize">{cat.name}</h3>
                  </div>
                </Link>
              ))}
            </div>
              ...
              <Link to="#" key={i} className={`relative group/card overflow-hidden rounded-sm block bg-white ${i === 0 || i === 1 ? 'col-span-3 h-[240px]' : 'col-span-2 h-[180px]'}`}>
                ...
                <div className="absolute inset-0 bg-white/60 backdrop-blur-sm group-hover/card:bg-white/40 transition-colors flex items-center justify-center">
                  <div className="bg-white/90 px-6 py-3 shadow-sm flex flex-col items-center">
                    <h3 className="text-[#101010] text-[13px] tracking-wide font-bold capitalize mb-1">{cat.name}</h3>
                    <span className="text-[10px] text-[#ff5474] capitalize tracking-wide font-bold opacity-0 group-hover/card:opacity-100 transition-opacity flex items-center gap-1">Shop <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7" /></svg></span>
                  </div>
                </div>
              </Link>
            ))}
          ...
          <div className="max-w-[1600px] mx-auto px-8 py-8 flex gap-8">
            ...
            <div className="w-[80%] flex gap-4">
              ...
              <Link to="/ring-builder" className="flex-1 bg-[#101010] border border-transparent p-6 flex flex-col items-center justify-center group/builder cursor-pointer hover:shadow-xl transition-all duration-300 text-center relative overflow-hidden">
                ...
                <h3 className="text-white font-serif text-[18px] lg:text-[22px] tracking-wide uppercase mb-10 relative z-10">BUILD YOUR RING</h3>
              ...
              <>
                <Link to="/ring-builder-guide" className="flex-1 bg-[#F5F2EC] p-8 relative flex flex-col group/card cursor-pointer overflow-hidden block">
                  <div className="relative z-10 mb-4">
                    <h3 className="text-[13px] font-sans font-semibold tracking-widest text-[#101010] uppercase mb-3">RING BUILDER</h3>
                ...
                <Link to="/about" className="flex-1 bg-[#F5F2EC] p-8 relative flex flex-col group/card cursor-pointer overflow-hidden block">
                  <div className="relative z-10 mb-4">
                    <h3 className="text-[13px] font-sans font-semibold tracking-widest text-[#101010] uppercase mb-3 leading-relaxed">SIGNATURE VS<br />CUSTOM PROCESS</h3>

...
export default function Header({ setIsCartOpen, setIsCountryModalOpen }) {
  ...
  return (
    <>
      {/* Topbar */}
      <div className="bg-[#2B2728]">
        <div className="max-w-[1600px] mx-auto text-white text-[11px] md:text-[13px] py-3 md:py-4 px-4 lg:px-8 flex items-center justify-between tracking-wide font-medium">
          <div className="flex items-center gap-3">
            ...
            <span className="opacity-90">+3929 299 999</span>
          </div>
          <div className="flex-1 flex justify-center mx-4 overflow-hidden">
            <div className="w-full max-w-[600px] overflow-hidden">
              <div className="whitespace-nowrap animate-marquee inline-block opacity-90 text-center">
                Only Pay 30% Upfront &nbsp; <svg className="inline w-3 h-3 text-[#ff5474] mx-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"></path></svg> &nbsp; VIP Hand Delivery Available in Gold Coast &amp; Auckland within 100 km.
              </div>
            </div>
          </div>

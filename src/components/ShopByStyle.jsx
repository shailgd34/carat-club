    ...
    <section className="py-24 bg-white text-center relative z-10 w-full overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-4 lg:px-8">
        ...
        <div className="mb-8 flex flex-col items-center">
          <h2 className="text-4xl lg:text-5xl font-serif text-[#101010] mb-4 tracking-wide font-medium capitalize">Shop By Style</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 items-stretch">
          ...
          <div className="bg-[#101010] flex flex-col items-center justify-between p-8 text-center h-[360px] relative overflow-hidden group shadow-lg">
            <div className="flex-1 flex flex-col items-center justify-center relative z-10">
              <h3 className="font-serif text-lg font-semibold text-white mb-6 capitalize tracking-wider">Build Your Ring</h3>
            ...
            <button className="whitespace-nowrap bg-[#ff5474] text-white text-[11px] capitalize tracking-wide font-semibold px-4 py-4 hover:shadow-[0_8px_25px_rgba(226,125,144,0.4)] transition-all w-full flex items-center justify-center gap-2 mt-6 relative z-10">
          ...
          <div className="bg-[#101010] flex flex-col items-center justify-between p-8 text-center h-[360px] relative overflow-hidden group shadow-lg">
            <div className="flex-1 flex flex-col items-center justify-center relative z-10">
              <h3 className="font-serif text-lg font-semibold text-white mb-6 leading-snug capitalize tracking-wider">Book A<br />Consultation</h3>

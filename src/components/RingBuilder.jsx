          ...
          <div className="w-full lg:w-[480px] flex-shrink-0 bg-white p-8 lg:p-12 border-t lg:border-t-0 lg:border-l border-[#E5E5E5] flex flex-col gap-10 relative z-20">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-6">
                ...
                <Link to="/ring-size-guide" target="_blank" className="text-[11px] text-[#101010] underline underline-offset-4 decoration-[#E5E5E5] hover:decoration-[#101010] transition-colors flex items-center gap-2 font-medium">
                  What's my size?
